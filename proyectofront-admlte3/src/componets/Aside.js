...
export default function Aside() {
  ...
  <a href="index.html" className="brand-link">
    <img src="dist/img/uni-park.png" alt="AdminLTE Logo" className="brand-image img-circle elevation-3" style={{opacity: '10',marginLeft:"-1px",marginTop:"-25px",maxHeight:"85px",border:"10px"}}  />
